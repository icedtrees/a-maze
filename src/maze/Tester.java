...
public class Tester {
    public static void main(String[] args) {        
        ...
        final Maze maze1 = new Maze(mazeHeight, windowHeight, straightness, branching, 1);
        c.gridx = 0;
        c.gridy = 0;
        f.add(maze1, c);
        ...
        final Maze maze2 = new Maze(mazeHeight, windowHeight, straightness, branching, 1);
        c.gridx = 1;
        c.gridy = 0;
        f.add(maze2, c);
    	...
    	straightness = 900 - ((difficulty % 10) * 100);
    	branching = 93 - ((difficulty % 10) * 10);
        final Maze maze3 = new Maze(mazeHeight, windowHeight, straightness, branching, 1);
        c.gridx = 0;
        c.gridy = 1;
        f.add(maze3, c);
    	...
    	straightness = 900 - ((difficulty % 10) * 100);
    	branching = 93 - ((difficulty % 10) * 10);
        final Maze maze4 = new Maze(mazeHeight, windowHeight, straightness, branching, 1);
        c.gridx = 1;
        c.gridy = 1;
        f.add(maze4, c);
