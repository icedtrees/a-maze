...
public class Campaign {
    ...
    {
        new CampaignLevel("Hello World!", new MazeSettings(false, true, 5, 8, 10, 40, 5, -1, MazeSettings.NO_MODIFICATIONS)),
        new CampaignLevel("Easy as pie", new MazeSettings(false, true, 7, 8, 7, 40, 5, -1, MazeSettings.NO_MODIFICATIONS)),
        new CampaignLevel("What's that ticking sound?", new MazeSettings(false, true, 9, 8, 5, 20, 5, -1, Arrays.asList(new Modification[] {
                new ClockMod(3)
        }))),
        new CampaignLevel("Time is tight", new MazeSettings(false, true, 11, 10, 5, 20, 5, -1, Arrays.asList(new Modification[] {
                new ClockMod(5)
        }))),
        new CampaignLevel("Run, run, run", new MazeSettings(false, true, 13, 10, 3, 30, 5, -1, Arrays.asList(new Modification[] {
                new SpeedMod(6),
                new ClockMod(3)
        }))),
        ...
        new CampaignLevel("Final Destination", new MazeSettings(false, false, 25, 10, -5, 120, 0, -1, Arrays.asList(new Modification[] {
                new SpeedMod(8),
                new ClockMod(14),
    ...
    private static final CampaignLevel[] multiPlayerLevels = new CampaignLevel[]
    {
        ...
        new CampaignLevel("Time is tight", new MazeSettings(true, true, 11, 10, 5, 20, 5, -1, Arrays.asList(new Modification[] {
                new ClockMod(5)
        }))),
        new CampaignLevel("Run, run, run", new MazeSettings(true, true, 13, 10, 3, 30, 5, -1, Arrays.asList(new Modification[] {
                new SpeedMod(6),
                new ClockMod(3)
        }))),
        ...
        new CampaignLevel("Final Destination", new MazeSettings(true, false, 25, 10, -5, 120, 0, -1, Arrays.asList(new Modification[] {
                new SpeedMod(8),
                new ClockMod(14),
                new FogMod(SINGLEPLAYER_DEFAULT_VISION, 8),
                new ShiftingWallsMod(8, 10)
